...
export const AppDescriptions: Record<string, string> = {
  ...
  terminal: "Émulateur de terminal pour Windows",
  iterm2: "Émulateur de terminal pour macOS",
  powershell: "Shell de ligne de commande et langage de script",
